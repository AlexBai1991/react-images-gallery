...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index2 = __webpack_require__(198);
	...
	dispatch((0, _index.initImages)(_mock2.default));
...
/***/ function(module, exports) {
	...
	exports.inverseImage = inverseImage;
	...
	function rearrangeImages(images) {
	  return {
...
/***/ function(module, exports) {
	...
	function images() {
	  ...
	  switch (action.type) {
	    ...
	    case 'CENTER_IMAGE':
	      return [].concat(_toConsumableArray(state.slice(0, action.index)), [Object.assign({}, state[action.index], { isCenter: !state[action.index].isCenter })], _toConsumableArray(state.slice(action.index + 1)));
	    case 'INVERSE_IMAGE':
	      return [].concat(_toConsumableArray(state.slice(0, action.index)), [Object.assign({}, state[action.index], { isInverse: !state[action.index].isInverse })], _toConsumableArray(state.slice(action.index + 1)));
	    default:
	      return state;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageFigures = __webpack_require__(201);
	
	var _ImageFigures2 = _interopRequireDefault(_ImageFigures);
	
	var _ControllerNavs = __webpack_require__(203);
	
	var _ControllerNavs2 = _interopRequireDefault(_ControllerNavs);
	...
	var App = function (_Component) {
	  ...
	  function App(props, context) {
	    ...
	    _this.inverse = _this.inverse.bind(_this);
	  ...
	  _createClass(App, [{
	    ...
	    key: 'getRandomRotate',
	    value: function getRandomRotate() {
	    ...
	    value: function center(index) {
	      ...
	      return function () {
	        var centerImage = _this2.props.actions.centerImage;
	        // 好像并没有起作用。。。然而并不知道为什么
	        // centerImage(index);
	    ...
	    value: function inverse(index) {
	      ...
	      return function () {
	        var inverseImage = _this3.props.actions.inverseImage;
	    ...
	    value: function reArrange(centerIndex) {
	      ...
	      var imgPosArr = imageInfo;
	      var centerPos = this.Constant.centerPos;
	      var hPosRange = this.Constant.hPosRange;
	      var vPosRange = this.Constant.vPosRange;
	      var leftSecX = hPosRange.leftSecX;
	      var rightSecX = hPosRange.rightSecX;
	      var hSectY = hPosRange.y;
	      var vSectX = vPosRange.x;
	      var topY = vPosRange.topY;
	      var centerImagePosArr = imgPosArr.splice(centerIndex, 1);
	      var topImageNum = Math.floor(Math.random() * 2);
	      var topSpliceImageIndex = Math.floor(Math.random() * (imgPosArr.length - topImageNum));
	      var topImagePosArr = imgPosArr.splice(topSpliceImageIndex, topImageNum);
	      ...
	      // 布局上方位置图片
	      topImagePosArr.forEach(function (imgPos, index) {
	        imgPos.pos = {
	          left: _this4.getRandom(vSectX),
	          top: _this4.getRandom(topY)
	        };
	        imgPos.rotate = _this4.getRandomRotate();
	        imgPos.isCenter = false;
	      });
	
	      // 布局左右两侧位置图片
	      var imgPosArrLen = imgPosArr.length;
	      imgPosArr.forEach(function (imgPos, index) {
	        ...
	        imgPos.pos = {
	          left: _this4.getRandom(leftOrRightSecX),
	          top: _this4.getRandom(hSectY)
	        };
	        imgPos.rotate = _this4.getRandomRotate();
	        imgPos.isCenter = false;
	      });
	      ...
	      var rearrangeImages = actions.rearrangeImages;
	    ...
	    value: function componentDidMount() {
	      var stageDOM = (0, _reactDom.findDOMNode)(this.refs.stage);
	      ...
	      var imageFigureDOM = (0, _reactDom.findDOMNode)(this.refs.imageFigures.imageFigure0);
	      var imageFigureW = imageFigureDOM.scrollWidth;
	      var imageFigureH = imageFigureDOM.offsetHeight;
	      var halfImageFigureW = Math.floor(imageFigureW / 2);
	      var halfImageFigureH = Math.floor(imageFigureH / 2);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'section',
	        { className: 'images-figures', ref: 'stage' },
	        _react2.default.createElement(_ImageFigures2.default, {
	          images: imageInfo,
	          actions: actions,
	          ref: 'imageFigures',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageFigure = __webpack_require__(202);
	...
	var ImageFigures = function (_Component) {
	  _inherits(ImageFigures, _Component);
	
	  function ImageFigures(props, context) {
	    _classCallCheck(this, ImageFigures);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageFigures).call(this, props, context));
	  }
	
	  _createClass(ImageFigures, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	    ...
	    value: function render() {
	      ...
	      var imagesArr = this.props.images.map(function (image, index) {
	        return _react2.default.createElement(_ImageFigure2.default, {
	          image: image,
	          key: index,
	          ref: 'imageFigure' + index,
	          center: _this2.props.onCenter(index),
	          inverse: _this2.props.onInverse(index)
	        });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageFigure = function (_Component) {
	  ...
	  function ImageFigure(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ImageFigure).call(this, props));
	  ...
	  _createClass(ImageFigure, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'figure',
	        { className: imageFigureclassName, style: styleObj, onClick: this.handleClick },
	        _react2.default.createElement('img', { src: this.props.image.imageUrl, alt: this.props.image.desc }),
