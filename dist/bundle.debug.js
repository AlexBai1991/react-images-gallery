...
/******/ 	var hotCurrentHash = "5b217bfe58f1d2de90f5"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_app2.default, { data: IMAGES }), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageFigures = __webpack_require__(172);
	
	var _ImageFigures2 = _interopRequireDefault(_ImageFigures);
	
	var _ControllerNavs = __webpack_require__(174);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ImageFigures2.default, { images: this.props.data, ref: 'imageFigures' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageFigure = __webpack_require__(173);
	...
	var ImageFigures = function (_Component) {
	  ...
	  function ImageFigures(props) {
	    _classCallCheck(this, ImageFigures);
	
	    // Constant
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ImageFigures).call(this, props));
	  ...
	  _createClass(ImageFigures, [{
	    ...
	    value: function inverse(index) {
	      ...
	      return function () {
	        var imgPosArr = _this3.state.imgPosArr;
	    ...
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var stageDOM = (0, _reactDom.findDOMNode)(this).parentNode;
	      var stageW = stageDOM.scrollWidth,
	          stageH = stageDOM.scrollHeight,
	          halfStageW = Math.floor(stageW / 2),
	          halfStageH = Math.floor(stageH / 2);
	      var imageFigureDOM = (0, _reactDom.findDOMNode)(this.refs.imageFigure0);
	    ...
	    value: function render() {
	      ...
	      this.props.images.forEach(function (image, index) {
	        if (!_this5.state.imgPosArr[index]) {
	          _this5.state.imgPosArr[index] = {
	            pos: {
	              left: 0,
	              top: 0
	            },
	        ...
	        imagesArr.push(_react2.default.createElement(_ImageFigure2.default, { image: image, arrange: _this5.state.imgPosArr[index], key: index, ref: 'imageFigure' + index, inverse: _this5.inverse(index), center: _this5.center(index) }));
	      });
	      return _react2.default.createElement(
	        'section',
	        { className: 'image-sec' },
